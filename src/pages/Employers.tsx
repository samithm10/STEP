    ...
    <div className="employers-page">
      ...
      <section className="employers-hero container">
        <div className="hero-content animate-fade-in">
          <div className="badge glass-panel">Industry Partner Workspace</div>
          <h1 className="hero-title">
            Source verified talent, publish <span className="gradient-text">live projects</span>, accelerate hiring
          </h1>
          <p className="hero-subtitle">
            Connect directly with verified students across 200+ top universities. Post skill-tagged internships, search talent with AI match-scoring, and manage applicant pipelines.
          </p>
          <div className="hero-actions">
            ...
            <button 
              ...
              onClick={() => {
                setActiveTab('talent');
                const dashboardEl = document.getElementById('dashboard-workspace');
                if (dashboardEl) dashboardEl.scrollIntoView({ behavior: 'smooth' });
              }}
            >
              <Search size={18} /> Search Talent Pool
            </button>
          </div>
        </div>
      </section>
      ...
      <section className="social-proof container">
        <div className="glass-panel proof-content">
          ...
          <div className="logo-grid">
            ...
            <div className="logo-placeholder">L&T Technology</div>
            <div className="logo-placeholder">Wipro</div>
          </div>
        </div>
      </section>
